...
if(trd_data['trade loc/typ'].loc[strt_dt:end_dt].any()):
    ...
    acnt_val_data, num_trds = acnt_val(data, trd_data)
...
prt_grph(data, trd_data, acnt_val_data, acnt_end_val_p, acnt_end_val_year_p, sma1, sma2, ema1, bb_upr, bb_lwr, kc_upr, kc_lwr, num_trds)